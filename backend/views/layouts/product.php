...
<head>
    ...
    <link rel="stylesheet" href="assets/css/formnhap2.css">
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            <ul>
                ...
                <li>
                    <a href="index.php?controller=product&action=index" class="active"><span class="las la-clipboard-list"></span>
                        <span>Sản Phẩm</span></a>
                </li>
                <li>
                    <a href="index.php?controller=order&action=index"><span class="las la-shopping-bag"></span>
